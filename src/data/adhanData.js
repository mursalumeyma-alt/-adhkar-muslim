// The Adhan (call to prayer) and Iqama (second, shorter call just before
// prayer begins). Wording follows the standard Sunni form established
// in the hadith of Abdullah ibn Zayd's dream, confirmed by the Prophet
// ﷺ and instituted as the call still used today. Arabic text is
// classical religious material in the public domain; the transliteration
// and translation below are my own.
...
export const adhanResponseDua = {
  ...
  reference: "Sahih al-Bukhari 614 — said after the muezzin finishes the adhan",
};

// The iqama — the shorter second call given immediately before the
// prayer itself begins, once the row (saff) is straight.
export const iqamaLines = [
  { id: "iqama-1", arabic: "اللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ", translation: "Allah is the Greatest, Allah is the Greatest", repeat: 1 },
  { id: "iqama-2", arabic: "أَشْهَدُ أَنْ لَا إِلَهَ إِلَّا اللَّهُ", translation: "I bear witness that there is no god but Allah", repeat: 1 },
  { id: "iqama-3", arabic: "أَشْهَدُ أَنَّ مُحَمَّدًا رَسُولُ اللَّهِ", translation: "I bear witness that Muhammad is the Messenger of Allah", repeat: 1 },
  { id: "iqama-4", arabic: "حَيَّ عَلَى الصَّلَاةِ", translation: "Come to prayer", repeat: 1 },
  { id: "iqama-5", arabic: "حَيَّ عَلَى الْفَلَاحِ", translation: "Come to success", repeat: 1 },
  { id: "iqama-6", arabic: "قَدْ قَامَتِ الصَّلَاةُ، قَدْ قَامَتِ الصَّلَاةُ", translation: "The prayer has begun, the prayer has begun", repeat: 1 },
  { id: "iqama-7", arabic: "اللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ", translation: "Allah is the Greatest, Allah is the Greatest", repeat: 1 },
  { id: "iqama-8", arabic: "لَا إِلَهَ إِلَّا اللَّهُ", translation: "There is no god but Allah", repeat: 1 },
];
